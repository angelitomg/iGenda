...
<head>
  ...
  <title><?= Configure::read('System.title') ?> | <?= $this->fetch('title'); ?></title>
  ...
  <!-- AdminLTE App -->
  <script src="<?= $this->Url->build('/') ?>/bower_components/AdminLTE/dist/js/app.min.js"></script>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><i class="fa fa-book"></i> &nbsp;<b>i</b>Genda</span>
    </a>
        ...
        <ul class="nav navbar-nav">
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <!-- User Image -->
                        <img src="<?= $this->Url->build('/') ?>/bower_components/AdminLTE/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                      </div>
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="<?= $this->Url->build('/') ?>/bower_components/AdminLTE/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
      ...
      <ul class="sidebar-menu">
        ...
        <li <?php if ($controller == 'Activities') echo 'class="active"'; ?>>
          <a href="<?= $this->Url->build(['controller' => 'Activities', 'action' => 'index']) ?>">
            <i class="fa fa-pencil-square-o"></i><span><?= __('Activities') ?></span>
          </a>
        </li>
        ...
        <li <?php if ($controller == 'Clients') echo 'class="active"'; ?>>
        ...
        <li <?php if ($controller == 'Companies') echo 'class="active"'; ?>>
          <a href="<?= $this->Url->build(['controller' => 'Companies', 'action' => 'edit']) ?>">
            <i class="fa fa-building-o"></i><span><?= __('Company Info') ?></span>
          </a>
        </li>

        <li <?php if ($controller == 'Deals') echo 'class="active"'; ?>>
          <a href="<?= $this->Url->build(['controller' => 'Deals', 'action' => 'index']) ?>">
            <i class="fa fa-folder-open-o"></i><span><?= __('Deals') ?></span>
          </a>
        </li>
        ...
        <li <?php if ($controller == 'Services') echo 'class="active"'; ?>>
          <a href="<?= $this->Url->build(['controller' => 'Services', 'action' => 'index']) ?>">
            <i class="fa fa-suitcase"></i><span><?= __('Services') ?></span>
          </a>
        </li>

        <li <?php if ($controller == 'Users') echo 'class="active"'; ?>>
          <a href="<?= $this->Url->build(['controller' => 'Users', 'action' => 'index']) ?>">
            <i class="fa fa-user-plus"></i><span><?= __('Users') ?></span>
          </a>
        </li>
  ...
  <footer class="main-footer">
    ...
    -->
    <!-- Default to the left -->
    <strong>Copyright &copy; <?= date('Y') ?> <a target="_blank" href="http://www.amglabs.net">AMG Labs</a></strong>
  </footer>
